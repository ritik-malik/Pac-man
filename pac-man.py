...
enemy_pos1=(13,1) ; enemy_pos2=(15,10) ; enemy_pos3=(11,13)
...
#In the board, '.' denote the empty space, 'w' are the walls, 'c' are the coins
	...
	if (pacman_position == enemy_pos1) or (pacman_position==enemy_pos2) or (pacman_position == enemy_pos3) or coin_len == 0:
		pygame.QUIT()
